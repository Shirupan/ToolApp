...
class GifWallpaperService : WallpaperService() {
    ...
    inner class WallpaperEngine(private val movie: Movie) : Engine() {
        ...
        override fun onCreate(surfaceHolder: SurfaceHolder?) {
            ...
            mClockPaint.color = ContextCompat.getColor(this@GifWallpaperService, R.color.colorAccent)
            mClockPaint.textSize = sp2px(this@GifWallpaperService, 50f).toFloat()
        ...
        private fun drawBackground(canvas: Canvas) {
            ...
            if (alwaysDark) {
                ...
                if (!autoDark) {
                    canvas.drawColor(
                        ContextCompat.getColor(this@GifWallpaperService, R.color.white)
                    )
                } else {
                    canvas.drawColor(
                        ContextCompat.getColor(
                        ...
                        if (totalTime >= 1024 * 1000) {
                            ...
                            if (jike_1024 && wallpaperVisible) {
                                val bitmap = ResourcesCompat.getDrawable(
                                    ...
                                    dip2px(this@GifWallpaperService, 24f),
                                    dip2px(this@GifWallpaperService, 24f)
                                )
                                canvas.drawBitmap(
                                    bitmap,
